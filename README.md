...
1.	To provide a high-level overview of sales health at a glance.
2.	To enable "drill-down" analysis into specific product categories.
3.	To track profitability and identify cost-saving opportunities.
...
•	Profitability by Sub-Category (Waterfall or Bar Chart): Breaks down which specific items are the most lucrative vs. those with thin margins.
•	Top 5 Customers/Products (Table/List): Identifies key drivers of revenue to help in loyalty program management or inventory stocking.

•	Business Impact & Insights
1.	Inventory Management: Spot slow-moving products early to avoid overstocking.
2.	Revenue Growth: Identify high-performing regions to double down on local advertising.
3.	Strategic Pricing: Use profit margin data to adjust pricing strategies on low-margin sub-categories.
